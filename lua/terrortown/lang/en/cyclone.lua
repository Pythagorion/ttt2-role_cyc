...
L["ttt2_text_chat_jam_" .. CYCLONE.name] = "You are not allowed to use text chat as long as you are marked."
...
L["label_cyclone_mute_intel"] = "If it's set on 'true', the marked player will not be able to use the voice chat, while being marked."
L["label_cyclone_mute_bool"] = "Disable possibility for marked player to use voice chat"

L["label_cyclone_tchat_intel"] = "If it's set on 'true', the marked player will not be able to use the team chat, while being marked."
L["label_cyclone_tchat_bool"] = "Disable possibility for marked player to use team chat"

L["label_cyclone_gchat_intel"] = "If it's set on 'true', the marked player will not be able to use the general chat, while being marked."
L["label_cyclone_gchat_bool"] = "Disable possibility for marked player to use general chat"
